...
[![Build Status](https://travis-ci.org/LIVEauctioneers/ramsql.svg)](https://travis-ci.org/LIVEauctioneers/ramsql)
...
```
  go get github.com/LIVEauctioneers/ramsql
```
...
```console
$ go install github.com/LIVEauctioneers/ramsql
$ ramsql < schema.sql
